...
4. **Ground-truth source per experiment** — PlantVillage folder labels give species +
   ...
   how to combine both.
5. **Preprocessing of the 45,096 facts** — used as-is, or restructured/deduplicated per
   field before embedding? Worth spot-checking a sample for near-duplicates or low-quality
   entries first.
